	...
	cases := []struct {
		...
		{field: "flow",
			want: []rule.Rule{
				...
				rule.MustNewOr(rule.NewLEFVF("flow", 1.05), rule.NewGEFVF("flow", 3.68)),
				...
				rule.MustNewOr(rule.NewLEFVF("flow", 1.05), rule.NewGEFVF("flow", 6.83)),
				rule.MustNewOr(rule.NewLEFVF("flow", 1.05), rule.NewGEFVF("flow", 7.88)),
				rule.MustNewOr(rule.NewLEFVF("flow", 1.05), rule.NewGEFVF("flow", 8.93)),
				...
				rule.MustNewOr(rule.NewLEFVF("flow", 2.1), rule.NewGEFVF("flow", 3.68)),
				...
				rule.MustNewOr(rule.NewLEFVF("flow", 2.1), rule.NewGEFVF("flow", 6.83)),
				rule.MustNewOr(rule.NewLEFVF("flow", 2.1), rule.NewGEFVF("flow", 7.88)),
				rule.MustNewOr(rule.NewLEFVF("flow", 2.1), rule.NewGEFVF("flow", 8.93)),
				rule.MustNewOr(rule.NewLEFVF("flow", 2.1), rule.NewGEFVF("flow", 9.45)),
				rule.NewLEFVF("flow", 3.68),
				rule.MustNewAnd(rule.NewLEFVF("flow", 3.68), rule.NewGEFVF("flow", 1.05)),
				rule.MustNewAnd(rule.NewLEFVF("flow", 3.68), rule.NewGEFVF("flow", 2.1)),
				rule.MustNewOr(rule.NewLEFVF("flow", 3.68), rule.NewGEFVF("flow", 4.2)),
				rule.MustNewOr(rule.NewLEFVF("flow", 3.68), rule.NewGEFVF("flow", 5.25)),
				rule.MustNewOr(rule.NewLEFVF("flow", 3.68), rule.NewGEFVF("flow", 6.83)),
				rule.MustNewOr(rule.NewLEFVF("flow", 3.68), rule.NewGEFVF("flow", 7.88)),
				rule.MustNewOr(rule.NewLEFVF("flow", 3.68), rule.NewGEFVF("flow", 8.93)),
				rule.MustNewOr(rule.NewLEFVF("flow", 3.68), rule.NewGEFVF("flow", 9.45)),
				rule.NewLEFVF("flow", 4.2),
				...
				rule.MustNewAnd(rule.NewLEFVF("flow", 4.2), rule.NewGEFVF("flow", 3.68)),
				rule.MustNewOr(rule.NewLEFVF("flow", 4.2), rule.NewGEFVF("flow", 5.25)),
				rule.MustNewOr(rule.NewLEFVF("flow", 4.2), rule.NewGEFVF("flow", 6.83)),
				rule.MustNewOr(rule.NewLEFVF("flow", 4.2), rule.NewGEFVF("flow", 7.88)),
				rule.MustNewOr(rule.NewLEFVF("flow", 4.2), rule.NewGEFVF("flow", 8.93)),
				...
				rule.MustNewAnd(rule.NewLEFVF("flow", 5.25), rule.NewGEFVF("flow", 3.68)),
				rule.MustNewAnd(rule.NewLEFVF("flow", 5.25), rule.NewGEFVF("flow", 4.2)),
				rule.MustNewOr(rule.NewLEFVF("flow", 5.25), rule.NewGEFVF("flow", 6.83)),
				rule.MustNewOr(rule.NewLEFVF("flow", 5.25), rule.NewGEFVF("flow", 7.88)),
				rule.MustNewOr(rule.NewLEFVF("flow", 5.25), rule.NewGEFVF("flow", 8.93)),
				rule.MustNewOr(rule.NewLEFVF("flow", 5.25), rule.NewGEFVF("flow", 9.45)),
				rule.NewLEFVF("flow", 6.83),
				rule.MustNewAnd(rule.NewLEFVF("flow", 6.83), rule.NewGEFVF("flow", 1.05)),
				rule.MustNewAnd(rule.NewLEFVF("flow", 6.83), rule.NewGEFVF("flow", 2.1)),
				rule.MustNewAnd(rule.NewLEFVF("flow", 6.83), rule.NewGEFVF("flow", 3.68)),
				rule.MustNewAnd(rule.NewLEFVF("flow", 6.83), rule.NewGEFVF("flow", 4.2)),
				rule.MustNewAnd(rule.NewLEFVF("flow", 6.83), rule.NewGEFVF("flow", 5.25)),
				rule.MustNewOr(rule.NewLEFVF("flow", 6.83), rule.NewGEFVF("flow", 7.88)),
				rule.MustNewOr(rule.NewLEFVF("flow", 6.83), rule.NewGEFVF("flow", 8.93)),
				rule.MustNewOr(rule.NewLEFVF("flow", 6.83), rule.NewGEFVF("flow", 9.45)),
				rule.NewLEFVF("flow", 7.88),
				rule.MustNewAnd(rule.NewLEFVF("flow", 7.88), rule.NewGEFVF("flow", 1.05)),
				rule.MustNewAnd(rule.NewLEFVF("flow", 7.88), rule.NewGEFVF("flow", 2.1)),
				rule.MustNewAnd(rule.NewLEFVF("flow", 7.88), rule.NewGEFVF("flow", 3.68)),
				rule.MustNewAnd(rule.NewLEFVF("flow", 7.88), rule.NewGEFVF("flow", 4.2)),
				rule.MustNewAnd(rule.NewLEFVF("flow", 7.88), rule.NewGEFVF("flow", 5.25)),
				rule.MustNewAnd(rule.NewLEFVF("flow", 7.88), rule.NewGEFVF("flow", 6.83)),
				rule.MustNewOr(rule.NewLEFVF("flow", 7.88), rule.NewGEFVF("flow", 8.93)),
				rule.MustNewOr(rule.NewLEFVF("flow", 7.88), rule.NewGEFVF("flow", 9.45)),
				rule.NewLEFVF("flow", 8.93),
				rule.MustNewAnd(rule.NewLEFVF("flow", 8.93), rule.NewGEFVF("flow", 1.05)),
				rule.MustNewAnd(rule.NewLEFVF("flow", 8.93), rule.NewGEFVF("flow", 2.1)),
				rule.MustNewAnd(rule.NewLEFVF("flow", 8.93), rule.NewGEFVF("flow", 3.68)),
				rule.MustNewAnd(rule.NewLEFVF("flow", 8.93), rule.NewGEFVF("flow", 4.2)),
				rule.MustNewAnd(rule.NewLEFVF("flow", 8.93), rule.NewGEFVF("flow", 5.25)),
				rule.MustNewAnd(rule.NewLEFVF("flow", 8.93), rule.NewGEFVF("flow", 6.83)),
				rule.MustNewAnd(rule.NewLEFVF("flow", 8.93), rule.NewGEFVF("flow", 7.88)),
				rule.MustNewOr(rule.NewLEFVF("flow", 8.93), rule.NewGEFVF("flow", 9.45)),
				...
				rule.MustNewAnd(rule.NewLEFVF("flow", 9.45), rule.NewGEFVF("flow", 3.68)),
				...
				rule.MustNewAnd(rule.NewLEFVF("flow", 9.45), rule.NewGEFVF("flow", 6.83)),
				rule.MustNewAnd(rule.NewLEFVF("flow", 9.45), rule.NewGEFVF("flow", 7.88)),
				rule.MustNewAnd(rule.NewLEFVF("flow", 9.45), rule.NewGEFVF("flow", 8.93)),
				rule.NewGEFVF("flow", 1.05),
				rule.NewGEFVF("flow", 2.1),
				rule.NewGEFVF("flow", 3.68),
				rule.NewGEFVF("flow", 4.2),
				rule.NewGEFVF("flow", 5.25),
				rule.NewGEFVF("flow", 6.83),
				rule.NewGEFVF("flow", 7.88),
				rule.NewGEFVF("flow", 8.93),
	...
	for i, c := range cases {
		for complexity := 1; complexity < 10; complexity++ {
			...
			if err := rulesContain(got, c.want); err != nil {
				t.Errorf("(%d) GenerateFloatRules: %s - got: %v", i, err, got)
			}
