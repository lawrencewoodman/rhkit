...
func TestGenerateIntRules(t *testing.T) {
	...
	wantRules := []rule.Rule{
		...
		rule.MustNewOr(rule.NewLEFVI("flow", 2), rule.NewLEFVI("flow", 3)),
		rule.MustNewOr(rule.NewLEFVI("flow", 2), rule.NewLEFVI("flow", 4)),
		rule.MustNewOr(rule.NewLEFVI("flow", 2), rule.NewGEFVI("flow", 1)),
		rule.MustNewOr(rule.NewLEFVI("flow", 2), rule.NewGEFVI("flow", 2)),
		...
		rule.MustNewOr(rule.NewLEFVI("flow", 3), rule.NewLEFVI("flow", 4)),
		rule.MustNewOr(rule.NewLEFVI("flow", 3), rule.NewGEFVI("flow", 1)),
		rule.MustNewOr(rule.NewLEFVI("flow", 3), rule.NewGEFVI("flow", 2)),
		rule.MustNewOr(rule.NewLEFVI("flow", 3), rule.NewGEFVI("flow", 3)),
		...
		rule.MustNewOr(rule.NewGEFVI("flow", 1), rule.NewGEFVI("flow", 3)),
...
func TestGenerateFloatRules(t *testing.T) {
	...
	wantRules := []rule.Rule{
		...
		rule.MustNewOr(rule.NewLEFVF("flow", 1.05), rule.NewLEFVF("flow", 2.1)),
		rule.MustNewOr(rule.NewLEFVF("flow", 1.05), rule.NewLEFVF("flow", 3.15)),
		rule.MustNewOr(rule.NewLEFVF("flow", 1.05), rule.NewLEFVF("flow", 4.2)),
		rule.MustNewOr(rule.NewLEFVF("flow", 1.05), rule.NewLEFVF("flow", 5.25)),
		rule.MustNewOr(rule.NewLEFVF("flow", 1.05), rule.NewLEFVF("flow", 6.3)),
		rule.MustNewOr(rule.NewLEFVF("flow", 1.05), rule.NewLEFVF("flow", 7.35)),
		rule.MustNewOr(rule.NewLEFVF("flow", 1.05), rule.NewLEFVF("flow", 8.4)),
		rule.MustNewOr(rule.NewLEFVF("flow", 1.05), rule.NewLEFVF("flow", 9.45)),
		rule.MustNewOr(rule.NewLEFVF("flow", 1.05), rule.NewGEFVF("flow", 0)),
		rule.MustNewOr(rule.NewLEFVF("flow", 1.05), rule.NewGEFVF("flow", 1.05)),
		...
		rule.MustNewOr(rule.NewLEFVF("flow", 2.1), rule.NewLEFVF("flow", 3.15)),
		rule.MustNewOr(rule.NewLEFVF("flow", 2.1), rule.NewLEFVF("flow", 4.2)),
		rule.MustNewOr(rule.NewLEFVF("flow", 2.1), rule.NewLEFVF("flow", 5.25)),
		rule.MustNewOr(rule.NewLEFVF("flow", 2.1), rule.NewLEFVF("flow", 6.3)),
		rule.MustNewOr(rule.NewLEFVF("flow", 2.1), rule.NewLEFVF("flow", 7.35)),
		rule.MustNewOr(rule.NewLEFVF("flow", 2.1), rule.NewLEFVF("flow", 8.4)),
		rule.MustNewOr(rule.NewLEFVF("flow", 2.1), rule.NewLEFVF("flow", 9.45)),
		rule.MustNewOr(rule.NewLEFVF("flow", 2.1), rule.NewGEFVF("flow", 0)),
		rule.MustNewOr(rule.NewLEFVF("flow", 2.1), rule.NewGEFVF("flow", 1.05)),
		rule.MustNewOr(rule.NewLEFVF("flow", 2.1), rule.NewGEFVF("flow", 2.1)),
		...
		rule.MustNewOr(rule.NewLEFVF("flow", 3.15), rule.NewLEFVF("flow", 4.2)),
		rule.MustNewOr(rule.NewLEFVF("flow", 3.15), rule.NewLEFVF("flow", 5.25)),
		rule.MustNewOr(rule.NewLEFVF("flow", 3.15), rule.NewLEFVF("flow", 6.3)),
		rule.MustNewOr(rule.NewLEFVF("flow", 3.15), rule.NewLEFVF("flow", 7.35)),
		rule.MustNewOr(rule.NewLEFVF("flow", 3.15), rule.NewLEFVF("flow", 8.4)),
		rule.MustNewOr(rule.NewLEFVF("flow", 3.15), rule.NewLEFVF("flow", 9.45)),
		rule.MustNewOr(rule.NewLEFVF("flow", 3.15), rule.NewGEFVF("flow", 0)),
		rule.MustNewOr(rule.NewLEFVF("flow", 3.15), rule.NewGEFVF("flow", 1.05)),
		rule.MustNewOr(rule.NewLEFVF("flow", 3.15), rule.NewGEFVF("flow", 2.1)),
		rule.MustNewOr(rule.NewLEFVF("flow", 3.15), rule.NewGEFVF("flow", 3.15)),
		...
		rule.MustNewOr(rule.NewLEFVF("flow", 4.2), rule.NewLEFVF("flow", 5.25)),
		rule.MustNewOr(rule.NewLEFVF("flow", 4.2), rule.NewLEFVF("flow", 6.3)),
		rule.MustNewOr(rule.NewLEFVF("flow", 4.2), rule.NewLEFVF("flow", 7.35)),
		rule.MustNewOr(rule.NewLEFVF("flow", 4.2), rule.NewLEFVF("flow", 8.4)),
		rule.MustNewOr(rule.NewLEFVF("flow", 4.2), rule.NewLEFVF("flow", 9.45)),
		rule.MustNewOr(rule.NewLEFVF("flow", 4.2), rule.NewGEFVF("flow", 0)),
		rule.MustNewOr(rule.NewLEFVF("flow", 4.2), rule.NewGEFVF("flow", 1.05)),
		rule.MustNewOr(rule.NewLEFVF("flow", 4.2), rule.NewGEFVF("flow", 2.1)),
		rule.MustNewOr(rule.NewLEFVF("flow", 4.2), rule.NewGEFVF("flow", 3.15)),
		rule.MustNewOr(rule.NewLEFVF("flow", 4.2), rule.NewGEFVF("flow", 4.2)),
		...
		rule.MustNewOr(rule.NewLEFVF("flow", 5.25), rule.NewLEFVF("flow", 6.3)),
		rule.MustNewOr(rule.NewLEFVF("flow", 5.25), rule.NewLEFVF("flow", 7.35)),
		rule.MustNewOr(rule.NewLEFVF("flow", 5.25), rule.NewLEFVF("flow", 8.4)),
		rule.MustNewOr(rule.NewLEFVF("flow", 5.25), rule.NewLEFVF("flow", 9.45)),
		rule.MustNewOr(rule.NewLEFVF("flow", 5.25), rule.NewGEFVF("flow", 0)),
		rule.MustNewOr(rule.NewLEFVF("flow", 5.25), rule.NewGEFVF("flow", 1.05)),
		rule.MustNewOr(rule.NewLEFVF("flow", 5.25), rule.NewGEFVF("flow", 2.1)),
		rule.MustNewOr(rule.NewLEFVF("flow", 5.25), rule.NewGEFVF("flow", 3.15)),
		rule.MustNewOr(rule.NewLEFVF("flow", 5.25), rule.NewGEFVF("flow", 4.2)),
		rule.MustNewOr(rule.NewLEFVF("flow", 5.25), rule.NewGEFVF("flow", 5.25)),
		...
		rule.MustNewOr(rule.NewLEFVF("flow", 6.3), rule.NewLEFVF("flow", 7.35)),
		rule.MustNewOr(rule.NewLEFVF("flow", 6.3), rule.NewLEFVF("flow", 8.4)),
		rule.MustNewOr(rule.NewLEFVF("flow", 6.3), rule.NewLEFVF("flow", 9.45)),
		rule.MustNewOr(rule.NewLEFVF("flow", 6.3), rule.NewGEFVF("flow", 0)),
		rule.MustNewOr(rule.NewLEFVF("flow", 6.3), rule.NewGEFVF("flow", 1.05)),
		rule.MustNewOr(rule.NewLEFVF("flow", 6.3), rule.NewGEFVF("flow", 2.1)),
		rule.MustNewOr(rule.NewLEFVF("flow", 6.3), rule.NewGEFVF("flow", 3.15)),
		rule.MustNewOr(rule.NewLEFVF("flow", 6.3), rule.NewGEFVF("flow", 4.2)),
		rule.MustNewOr(rule.NewLEFVF("flow", 6.3), rule.NewGEFVF("flow", 5.25)),
		rule.MustNewOr(rule.NewLEFVF("flow", 6.3), rule.NewGEFVF("flow", 6.3)),
		...
		rule.MustNewOr(rule.NewLEFVF("flow", 7.35), rule.NewLEFVF("flow", 8.4)),
		rule.MustNewOr(rule.NewLEFVF("flow", 7.35), rule.NewLEFVF("flow", 9.45)),
		rule.MustNewOr(rule.NewLEFVF("flow", 7.35), rule.NewGEFVF("flow", 0)),
		rule.MustNewOr(rule.NewLEFVF("flow", 7.35), rule.NewGEFVF("flow", 1.05)),
		rule.MustNewOr(rule.NewLEFVF("flow", 7.35), rule.NewGEFVF("flow", 2.1)),
		rule.MustNewOr(rule.NewLEFVF("flow", 7.35), rule.NewGEFVF("flow", 3.15)),
		rule.MustNewOr(rule.NewLEFVF("flow", 7.35), rule.NewGEFVF("flow", 4.2)),
		rule.MustNewOr(rule.NewLEFVF("flow", 7.35), rule.NewGEFVF("flow", 5.25)),
		rule.MustNewOr(rule.NewLEFVF("flow", 7.35), rule.NewGEFVF("flow", 6.3)),
		rule.MustNewOr(rule.NewLEFVF("flow", 7.35), rule.NewGEFVF("flow", 7.35)),
		...
		rule.MustNewOr(rule.NewLEFVF("flow", 8.4), rule.NewLEFVF("flow", 9.45)),
		rule.MustNewOr(rule.NewLEFVF("flow", 8.4), rule.NewGEFVF("flow", 0)),
		rule.MustNewOr(rule.NewLEFVF("flow", 8.4), rule.NewGEFVF("flow", 1.05)),
		rule.MustNewOr(rule.NewLEFVF("flow", 8.4), rule.NewGEFVF("flow", 2.1)),
		rule.MustNewOr(rule.NewLEFVF("flow", 8.4), rule.NewGEFVF("flow", 3.15)),
		rule.MustNewOr(rule.NewLEFVF("flow", 8.4), rule.NewGEFVF("flow", 4.2)),
		rule.MustNewOr(rule.NewLEFVF("flow", 8.4), rule.NewGEFVF("flow", 5.25)),
		rule.MustNewOr(rule.NewLEFVF("flow", 8.4), rule.NewGEFVF("flow", 6.3)),
		rule.MustNewOr(rule.NewLEFVF("flow", 8.4), rule.NewGEFVF("flow", 7.35)),
		rule.MustNewOr(rule.NewLEFVF("flow", 8.4), rule.NewGEFVF("flow", 8.4)),
		...
		rule.MustNewOr(rule.NewLEFVF("flow", 9.45), rule.NewGEFVF("flow", 0)),
		rule.MustNewOr(rule.NewLEFVF("flow", 9.45), rule.NewGEFVF("flow", 1.05)),
		rule.MustNewOr(rule.NewLEFVF("flow", 9.45), rule.NewGEFVF("flow", 2.1)),
		rule.MustNewOr(rule.NewLEFVF("flow", 9.45), rule.NewGEFVF("flow", 3.15)),
		rule.MustNewOr(rule.NewLEFVF("flow", 9.45), rule.NewGEFVF("flow", 4.2)),
		rule.MustNewOr(rule.NewLEFVF("flow", 9.45), rule.NewGEFVF("flow", 5.25)),
		rule.MustNewOr(rule.NewLEFVF("flow", 9.45), rule.NewGEFVF("flow", 6.3)),
		rule.MustNewOr(rule.NewLEFVF("flow", 9.45), rule.NewGEFVF("flow", 7.35)),
		rule.MustNewOr(rule.NewLEFVF("flow", 9.45), rule.NewGEFVF("flow", 8.4)),
		rule.MustNewOr(rule.NewLEFVF("flow", 9.45), rule.NewGEFVF("flow", 9.45)),
		rule.NewGEFVF("flow", 0.0),
		rule.MustNewOr(rule.NewGEFVF("flow", 0), rule.NewGEFVF("flow", 1.05)),
		rule.MustNewOr(rule.NewGEFVF("flow", 0), rule.NewGEFVF("flow", 2.1)),
		rule.MustNewOr(rule.NewGEFVF("flow", 0), rule.NewGEFVF("flow", 3.15)),
		rule.MustNewOr(rule.NewGEFVF("flow", 0), rule.NewGEFVF("flow", 4.2)),
		rule.MustNewOr(rule.NewGEFVF("flow", 0), rule.NewGEFVF("flow", 5.25)),
		rule.MustNewOr(rule.NewGEFVF("flow", 0), rule.NewGEFVF("flow", 6.3)),
		rule.MustNewOr(rule.NewGEFVF("flow", 0), rule.NewGEFVF("flow", 7.35)),
		rule.MustNewOr(rule.NewGEFVF("flow", 0), rule.NewGEFVF("flow", 8.4)),
		rule.MustNewOr(rule.NewGEFVF("flow", 0), rule.NewGEFVF("flow", 9.45)),
		rule.NewGEFVF("flow", 1.05),
		rule.MustNewOr(rule.NewGEFVF("flow", 1.05), rule.NewGEFVF("flow", 2.1)),
		rule.MustNewOr(rule.NewGEFVF("flow", 1.05), rule.NewGEFVF("flow", 3.15)),
		rule.MustNewOr(rule.NewGEFVF("flow", 1.05), rule.NewGEFVF("flow", 4.2)),
		rule.MustNewOr(rule.NewGEFVF("flow", 1.05), rule.NewGEFVF("flow", 5.25)),
		rule.MustNewOr(rule.NewGEFVF("flow", 1.05), rule.NewGEFVF("flow", 6.3)),
		rule.MustNewOr(rule.NewGEFVF("flow", 1.05), rule.NewGEFVF("flow", 7.35)),
		rule.MustNewOr(rule.NewGEFVF("flow", 1.05), rule.NewGEFVF("flow", 8.4)),
		rule.MustNewOr(rule.NewGEFVF("flow", 1.05), rule.NewGEFVF("flow", 9.45)),
		rule.NewGEFVF("flow", 2.1),
		rule.MustNewOr(rule.NewGEFVF("flow", 2.1), rule.NewGEFVF("flow", 3.15)),
		rule.MustNewOr(rule.NewGEFVF("flow", 2.1), rule.NewGEFVF("flow", 4.2)),
		rule.MustNewOr(rule.NewGEFVF("flow", 2.1), rule.NewGEFVF("flow", 5.25)),
		rule.MustNewOr(rule.NewGEFVF("flow", 2.1), rule.NewGEFVF("flow", 6.3)),
		rule.MustNewOr(rule.NewGEFVF("flow", 2.1), rule.NewGEFVF("flow", 7.35)),
		rule.MustNewOr(rule.NewGEFVF("flow", 2.1), rule.NewGEFVF("flow", 8.4)),
		rule.MustNewOr(rule.NewGEFVF("flow", 2.1), rule.NewGEFVF("flow", 9.45)),
		rule.NewGEFVF("flow", 3.15),
		rule.MustNewOr(rule.NewGEFVF("flow", 3.15), rule.NewGEFVF("flow", 4.2)),
		rule.MustNewOr(rule.NewGEFVF("flow", 3.15), rule.NewGEFVF("flow", 5.25)),
		rule.MustNewOr(rule.NewGEFVF("flow", 3.15), rule.NewGEFVF("flow", 6.3)),
		rule.MustNewOr(rule.NewGEFVF("flow", 3.15), rule.NewGEFVF("flow", 7.35)),
		rule.MustNewOr(rule.NewGEFVF("flow", 3.15), rule.NewGEFVF("flow", 8.4)),
		rule.MustNewOr(rule.NewGEFVF("flow", 3.15), rule.NewGEFVF("flow", 9.45)),
		rule.NewGEFVF("flow", 4.2),
		rule.MustNewOr(rule.NewGEFVF("flow", 4.2), rule.NewGEFVF("flow", 5.25)),
		rule.MustNewOr(rule.NewGEFVF("flow", 4.2), rule.NewGEFVF("flow", 6.3)),
		rule.MustNewOr(rule.NewGEFVF("flow", 4.2), rule.NewGEFVF("flow", 7.35)),
		rule.MustNewOr(rule.NewGEFVF("flow", 4.2), rule.NewGEFVF("flow", 8.4)),
		rule.MustNewOr(rule.NewGEFVF("flow", 4.2), rule.NewGEFVF("flow", 9.45)),
		rule.NewGEFVF("flow", 5.25),
		rule.MustNewOr(rule.NewGEFVF("flow", 5.25), rule.NewGEFVF("flow", 6.3)),
		rule.MustNewOr(rule.NewGEFVF("flow", 5.25), rule.NewGEFVF("flow", 7.35)),
		rule.MustNewOr(rule.NewGEFVF("flow", 5.25), rule.NewGEFVF("flow", 8.4)),
		rule.MustNewOr(rule.NewGEFVF("flow", 5.25), rule.NewGEFVF("flow", 9.45)),
		rule.NewGEFVF("flow", 6.3),
		rule.MustNewOr(rule.NewGEFVF("flow", 6.3), rule.NewGEFVF("flow", 7.35)),
		rule.MustNewOr(rule.NewGEFVF("flow", 6.3), rule.NewGEFVF("flow", 8.4)),
		rule.MustNewOr(rule.NewGEFVF("flow", 6.3), rule.NewGEFVF("flow", 9.45)),
		rule.NewGEFVF("flow", 7.35),
		rule.MustNewOr(rule.NewGEFVF("flow", 7.35), rule.NewGEFVF("flow", 8.4)),
		rule.MustNewOr(rule.NewGEFVF("flow", 7.35), rule.NewGEFVF("flow", 9.45)),
		rule.NewGEFVF("flow", 8.4),
		rule.MustNewOr(rule.NewGEFVF("flow", 8.4), rule.NewGEFVF("flow", 9.45)),
	...
	cases := []struct {
		...
		{in: []rule.Rule{
			...
			want: []rule.Rule{
				...
				rule.MustNewOr(rule.NewGEFVI("band", 2), rule.NewGEFVI("band", 4)),
