...
func TestGeneratePoints(t *testing.T) {
	cases := []struct {
		...
		{min: dlit.MustNew(10.2678945), max: dlit.MustNew(15.2382745), maxDP: 6,
			want: []*dlit.Literal{
				dlit.MustNew(10.5), dlit.MustNew(10.516), dlit.MustNew(10.516414),
				dlit.MustNew(10.52), dlit.MustNew(10.76), dlit.MustNew(10.764933),
				dlit.MustNew(10.765), dlit.MustNew(10.8), dlit.MustNew(11),
				dlit.MustNew(11.01), dlit.MustNew(11.013), dlit.MustNew(11.013452),
				dlit.MustNew(11.26), dlit.MustNew(11.261971), dlit.MustNew(11.262),
				dlit.MustNew(11.3), dlit.MustNew(11.5), dlit.MustNew(11.51),
				dlit.MustNew(11.51049), dlit.MustNew(11.759), dlit.MustNew(11.759009),
				dlit.MustNew(11.76), dlit.MustNew(11.8), dlit.MustNew(12),
				dlit.MustNew(12.007528), dlit.MustNew(12.008), dlit.MustNew(12.01),
				dlit.MustNew(12.256), dlit.MustNew(12.256047), dlit.MustNew(12.26),
				...
				dlit.MustNew(13.001604), dlit.MustNew(13.002), dlit.MustNew(13.25),
				dlit.MustNew(13.250123), dlit.MustNew(13.3), dlit.MustNew(13.498642),
				dlit.MustNew(13.499), dlit.MustNew(13.5), dlit.MustNew(13.7),
				dlit.MustNew(13.747), dlit.MustNew(13.747161), dlit.MustNew(13.75),
				dlit.MustNew(13.99568), dlit.MustNew(13.996), dlit.MustNew(14),
				dlit.MustNew(14.2), dlit.MustNew(14.24), dlit.MustNew(14.244),
				dlit.MustNew(14.244199), dlit.MustNew(14.49), dlit.MustNew(14.492718),
				dlit.MustNew(14.493), dlit.MustNew(14.5), dlit.MustNew(14.7),
				dlit.MustNew(14.74), dlit.MustNew(14.741), dlit.MustNew(14.741237),
